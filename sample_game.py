...
class ChessGUI(QWidget, ChessGame):
    ...
    def get_play_time(self):
        ...
        try:
            ...
            game_file_name = 'game2.txt'
            game_file  =open(f'sample_games/{game_file_name}', 'r')
            for user_move in game_file:
                #read move and make user move
                if user_move:
                    try:
            ...
            file_name = f'{algo}_{game_file_name}_{datetime.date.today()}.txt'
